...
const Index = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-b from-[#E5DEFF] to-white">
      {/* Hero Section */}
      <section className="min-h-screen flex items-center justify-center px-4 animate-fade-in bg-blue-200 hover:bg-blue-100">
        <div className="text-center">
          <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-[#8B5CF6] to-[#D946EF] bg-clip-text mb-6 text-blue-950">
            ROHAN
          </h1>
          <p className="text-xl text-gray-700 mb-8 md:text-3xl font-semibold">Social Handles</p>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-[#FEC6A1] to-[#FFDEE2]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {skills.map((skill, index) => <div key={index} className="p-6 glass-card rounded-xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <ScrollArea className="h-[800px] rounded-md">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-4">
              {certifications.map((cert, index) => <div key={index} className="p-6 glass-card rounded-xl hover:shadow-xl transition-all duration-300">
                  <img src={cert.image} alt={cert.title} className="w-full h-48 object-contain mb-4" />
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-[#8B5CF6] to-[#D946EF] text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a href="mailto:rohanmahendranr@gmail.com" className="inline-flex items-center gap-2 bg-white text-[#8B5CF6] px-6 py-3 rounded-lg font-semibold hover:bg-opacity-90 transition-colors">
